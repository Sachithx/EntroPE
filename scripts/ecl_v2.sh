#!/bin/bash
# Train EntroPE_v2 on the ECL dataset (321 channels, 17544 steps).
...
# ── Dataset ────────────────────────────────────────────────────────────────
data=custom
root_path=/home/AD/sachith/PRECEPT_BASELINES/EntroPE/dataset/electricity
data_path=electricity.csv
model_id_name=ECL
enc_in=321
freq=h
seq_len=96
batch_size=32          # large channel count — keep batch small to fit GPU
...
mvg_cov_rank=4         # low-rank+diag: 321 + 321*4 = 1605 features vs 51681 full
...
for pred_len in 96 192 336 720; do
    ...
    model_id="${model_id_name}_${seq_len}_${pred_len}_ape_fusion_local1_d128"

    echo "========================================================"
    echo "ECL  seq=${seq_len}  pred=${pred_len}"
    echo "========================================================"
...
echo "All ECL experiments finished."
